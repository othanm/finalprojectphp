...
$q="SELECT * FROM user_form WHERE id=$id"; 
...
if(isset($_POST['submit'])){
   ...
   echo "<br>";
   echo "<a href='allusers.php'>CLICK HERE TO RESULT</a>";
...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="password" required placeholder="enter your password" value=<?php echo $pass ?>>
